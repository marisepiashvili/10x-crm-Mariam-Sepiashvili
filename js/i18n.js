...
const TRANSLATIONS = {
  en: {
    ...
    'field.noFileChosen': 'No file chosen',
    ...
    'sort.valueAsc': 'Deal value: low → high',
    ...
    'modal.editClient.title': 'Edit Client',
    'btn.editClientSubmit': 'Save Changes',
    'btn.edit': 'Edit',
    ...
    'bulk.changeStatus': 'Change status to…',
    'bulk.deleteSelected': 'Delete selected',
    'bulk.clearSelection': 'Clear',
    'confirm.bulkDelete': 'Delete {{count}} selected clients? This cannot be undone.',
    'toast.bulkDeleted': '{{count}} clients deleted',
    'toast.bulkStatusChanged': 'Status updated for selected clients ✓',
  ...
  ka: {
    ...
    'login.subtitle': 'შედით სისტემაში მიმდინარე პროცესების სანახავად.',
    'login.submit': 'შესვლა',
    ...
    'field.photo': 'ფოტო',
    'btn.uploadPhoto': 'ფოტოს ატვირთვა',
    'field.noFileChosen': 'ფაილი არჩეული არ არის',
    ...
    'error.passwordWeak': 'პაროლი უნდა შედგებოდეს მინიმუმ 8 სიმბოლოსგან და შეიცავდეს ასოსა და ციფრს',
    ...
    'dashboard.subtitle': 'ასე გამოიყურება თქვენი მიმდინარე პროცესები.',
    ...
    'card.recentClients': 'ბოლოს დამატებული კლიენტები',
    ...
    'chip.all': 'ყველა',
    'sort.newest': 'ბოლოს დამატებული',
    'sort.name': 'სახელი A → Z',
    'sort.value': 'გარიგების ღირებულება: მაღალი → დაბალი',
    'sort.valueAsc': 'გარიგების ღირებულება: დაბალი → მაღალი',
    ...
    'modal.editClient.title': 'კლიენტის რედაქტირება',
    'btn.editClientSubmit': 'ცვლილებების შენახვა',
    'btn.edit': 'რედაქტირება',
    'toast.clientUpdated': 'კლიენტი განახლდა ✓',
    ...
    'bulk.selectAll': 'ყველას მონიშვნა',
    'bulk.selectedCount': 'მონიშნულია {{count}}',
    'bulk.changeStatus': 'სტატუსის შეცვლა...',
    'bulk.deleteSelected': 'მონიშნულის წაშლა',
    'bulk.clearSelection': 'გასუფთავება',
    'confirm.bulkDelete': 'წავშალო {{count}} მონიშნული კლიენტი? ამის გაუქმება შეუძლებელია.',
    'toast.bulkDeleted': '{{count}} კლიენტი წაიშალა',
    'toast.bulkStatusChanged': 'მონიშნული კლიენტების სტატუსი განახლდა ✓',
